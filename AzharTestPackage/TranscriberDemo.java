...
public class TranscriberDemo {
	...
	static final String LM_Name = "TIMIT.test.lm";
...
//        configuration.setAcousticModelPath("resource:/edu/cmu/sphinx/models/en-us/en-us");
        System.out.println("file:"+ ModelsPath +AcModel0);
        configuration.setAcousticModelPath("file:"+ ModelsPath +AcModel0);
...
//        configuration.setLanguageModelPath("resource:/edu/cmu/sphinx/models/en-us/en-us.lm.bin");
        ...
        configuration.setDictionaryPath("file:"+DictName);
        configuration.setLanguageModelPath(LM_Name);
        
        System.out.println("Speech file Abs Path:" + speechFilePath);
        StreamSpeechRecognizer recognizer = new StreamSpeechRecognizer(configuration);
        InputStream stream = TranscriberDemo.class
                .getResourceAsStream(speechFilePath);
        //stream.skip(44);
